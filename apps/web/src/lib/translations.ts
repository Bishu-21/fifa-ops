...
export const translations: Record<Language, TranslationSet> = {
  en: {
    ...
    provision: {
      ...
      securityToken: "WebAuthn Hardware Cryptography",
      btnSync: "Force Caching Assets & PWA",
      syncing: "Caching 15MB Offline Pack...",
    ...
    deck: {
      ...
      subtitle: "Crowd levels are live. Gemini 3.1 Flash Lite is parsing sensor telemetries to issue direct action guidelines. Pay attention.",
  ...
  es: {
    ...
    provision: {
      ...
      securityToken: "Criptografía WebAuthn",
      btnSync: "Descargar Mapas y PWA",
      syncing: "Cachando 15MB de datos locales...",
    ...
    deck: {
      ...
      subtitle: "Los niveles de flujo están activos. Gemini 3.1 analiza la telemetría en tiempo real y dicta comandos. Presta atención.",
  ...
  fr: {
    ...
    provision: {
      ...
      securityToken: "Cryptographie WebAuthn",
      btnSync: "Télécharger les Fichiers & PWA",
      syncing: "Téléchargement de 15Mo de données...",
    ...
    deck: {
      ...
      subtitle: "Trafic en temps réel. Gemini 3.1 analyse la télémétrie des capteurs et génère des consignes claires. Soyez attentifs.",
  ...
  pt: {
    ...
    provision: {
      ...
      securityToken: "Criptografia WebAuthn",
      btnSync: "Sincronizar Arquivos e PWA",
      syncing: "Salvando 15MB de assets locais...",
    ...
    calibrate: {
      ...
      subtitle: "Sim, você está alocado no Setor 7G. Não, não podemos te mandar para a tribuna VIP. Calibre seus sensores e teste os ruidômetros.",
    ...
    deck: {
      ...
      subtitle: "Densidade de fluxo ao vivo. Gemini 3.1 traduz os dados dos sensores e cospe diretivas de ação. Mantenha os olhos abertos.",
  ...
  ar: {
    common: {
      ...
      networkOffline: "وضع العمل بدون اتصال",
    ...
    provision: {
      ...
      securityToken: "التشفير المعتمد على أجهزة WebAuthn",
      btnSync: "بدء مزامنة البيانات والعمل بدون اتصال",
      syncing: "جاري تحميل 15 ميجابايت من البيانات المحلية...",
    ...
    deck: {
      ...
      subtitle: "مستويات الحشود محدثة مباشرة. يقوم محرك Gemini 3.1 بتحليل قراءات أجهزة الاستشعار لإصدار تعليمات العمل المباشرة. انتبه جيدًا.",
  ...
  zh: {
    ...
    provision: {
      ...
      securityToken: "WebAuthn 硬件加密模块",
      btnSync: "强制下载地图及离线包",
      syncing: "正在缓存 15MB 离线数据...",
      done: "离线包完全载入成功",
